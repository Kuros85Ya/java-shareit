...
class BookingRepositoryTest {
    ...
    void createData() {
        ...
        bookingRepository.save(new Booking(null, startTime1, endTime1, item1, booker, Status.WAITING, created1));
        bookingRepository.save(new Booking(null, startTime2, endTime2, item2, booker, Status.WAITING, created2));
    }
    ...
    void getAllUserItems_whenSeveralItemsHaveBooking_ThenAllAreReturned() {
        ...
        Request request = new Request(1, "ReqDescription", booker, created1);

        Item item1 = new Item(1, "itemName", "itemDesc", true, booker, request);
        Item item2 = new Item(2, "itemName2", "itemDesc2", true, booker, request);

        Booking booking1 = new Booking(1, startTime1, endTime1, item1, booker, Status.WAITING, created1);
        Booking booking2 = new Booking(2, startTime2, endTime2, item2, booker, Status.WAITING, created2);

        List<Booking> bookingListExpected = Arrays.asList(booking1, booking2); //mutable list
